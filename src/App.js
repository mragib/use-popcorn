...
export default function App() {
  ...
  const [watched, setWatched] = useLocalStrage([], "watched");
  ...
  function handleDeleteMovie(id) {
    setWatched((watch) => watch.filter((item) => item.imdbID !== id));
  }
        ...
        <Box>
          {selectedId ? (
            ...
            <>
              ...
              <WatchedList
                watched={watched}
                onDeleteWatchMovie={handleDeleteMovie}
              />
            </>
          )}
        </Box>
...
function MovieDetails({
  ...
  const isWatched = watchList.map((movie) => movie.imdbID).includes(selectedId);
  const watchMovieUserRating = watchList.find(
          ...
          <section>
            <div className="rating">
              {!isWatched ? (
                ...
                <p>You already rated this movie with {watchMovieUserRating}</p>
              )}
            </div>
            <p>
              <em>{plot}</em>
